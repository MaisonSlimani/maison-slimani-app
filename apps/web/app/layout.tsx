...
const navigationSchema = {
  ...
  '@type': 'ItemList',
  'itemListElement': [
    { '@type': 'SiteNavigationElement', 'position': 1, 'name': 'Boutique', 'description': 'Tous nos produits', 'url': 'https://www.maison-slimani.com/boutique' },
    { '@type': 'SiteNavigationElement', 'position': 2, 'name': 'La Maison', 'description': 'Notre histoire et savoir-faire', 'url': 'https://www.maison-slimani.com/maison' },
    { '@type': 'SiteNavigationElement', 'position': 3, 'name': 'Contact', 'description': 'Contactez-nous', 'url': 'https://www.maison-slimani.com/contact' }
  ]
}
  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      <head>
        ...
        <link rel="preload" as="image" href="/assets/hero-chaussures.jpg" fetchPriority="high" />
